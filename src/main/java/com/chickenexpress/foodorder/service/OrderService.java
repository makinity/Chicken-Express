...
public class OrderService {
    ...
    // Simple in-memory counter to generate sequential order numbers per day.
    // In production, a DB sequence or UUID is more robust.
    ...
    private String generateOrderNumber() {
        ...
        return String.format("CE-%s-%04d", datePart, seq);
    }
}
